...
import { Database, Search, Trash2, BrainCircuit, BookOpen, UserCircle, Globe } from "lucide-react";
        ...
        {filteredMemories.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredMemories.map((memory) => (
              <NeuralCard key={memory.id} className="p-6 flex flex-col h-full group">
                ...
                <div className="mt-6 pt-4 border-t border-white/5 flex justify-end">
                  <button className="text-white/20 hover:text-alert-pink transition-colors">
                    <Trash2 size={14} />
                  </button>
                </div>
              </NeuralCard>
