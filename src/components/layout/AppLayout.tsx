    ...
    <TooltipProvider>
      <SidebarProvider defaultOpen={true}>
        <div className="flex h-screen w-full overflow-hidden bg-neural-bg text-foreground relative">
          ...
          <main className="relative flex flex-1 flex-col overflow-hidden border-x border-white/5 z-10">
            <TopBar />
          ...
          <AnimatePresence>
            {isPeripheralOpen && peripheral && (
              <motion.aside
                ...
                className="hidden lg:block border-l border-white/5 bg-[#0a0e1a]/40 backdrop-blur-md z-20"
              >
